...
START_DIR                 = C:/Users/LENOWO~1/DOCUME~1/SEB/tracking/SIMULA~1
TGT_FCN_LIB               = ISO_C++11
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = codegenTest_rtw_comp.rsp
CMD_FILE                  = codegenTest_rtw.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = codegenTest.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=codegenTest
...
%.obj : $(START_DIR)/codegen/lib/codegenTest/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/codegenTest/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/codegenTest/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/codegenTest/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/codegenTest/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
codegenTest_data.obj : $(START_DIR)/codegen/lib/codegenTest/codegenTest_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/codegen/lib/codegenTest/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/codegen/lib/codegenTest/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/codegen/lib/codegenTest/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


codegenTest_initialize.obj : $(START_DIR)/codegen/lib/codegenTest/codegenTest_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


codegenTest_terminate.obj : $(START_DIR)/codegen/lib/codegenTest/codegenTest_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


codegenTest.obj : $(START_DIR)/codegen/lib/codegenTest/codegenTest.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


minOrMax.obj : $(START_DIR)/codegen/lib/codegenTest/minOrMax.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
xgeqp3.obj : $(START_DIR)/codegen/lib/codegenTest/xgeqp3.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


constacc.obj : $(START_DIR)/codegen/lib/codegenTest/constacc.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


KalmanFilter.obj : $(START_DIR)/codegen/lib/codegenTest/KalmanFilter.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


trackingKF.obj : $(START_DIR)/codegen/lib/codegenTest/trackingKF.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CombinedTracker.obj : $(START_DIR)/codegen/lib/codegenTest/CombinedTracker.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
