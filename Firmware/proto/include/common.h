...
typedef enum EnableDisableEnum {
    ENABLE = 1,
    DISABLE = 0,
} EnableDisableEnum;
...
#define CHANNEL_AC_NOS_EMERGENCY_VENT 5
#ifdef BOARD_AC_1
...
#define CHANNEL_PT_NOS_INJECTOR 3
#ifdef BOARD_PT_2
...
#define CHANNEL_TC_ENGINE_0 0
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_0 true
#else
#define IS_BOARD_FOR_TC_ENGINE_0 false
#endif

#define CHANNEL_TC_ENGINE_1 1
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_1 true
#else
#define IS_BOARD_FOR_TC_ENGINE_1 false
#endif

#define CHANNEL_TC_ENGINE_2 2
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_2 true
#else
#define IS_BOARD_FOR_TC_ENGINE_2 false
#endif

#define CHANNEL_TC_ENGINE_3 3
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_3 true
#else
#define IS_BOARD_FOR_TC_ENGINE_3 false
#endif

#define CHANNEL_TC_ENGINE_4 4
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_4 true
#else
#define IS_BOARD_FOR_TC_ENGINE_4 false
#endif

#define CHANNEL_TC_ENGINE_5 5
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_5 true
#else
#define IS_BOARD_FOR_TC_ENGINE_5 false
#endif

#define CHANNEL_TC_ENGINE_6 6
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_6 true
#else
#define IS_BOARD_FOR_TC_ENGINE_6 false
#endif

#define CHANNEL_TC_ENGINE_7 7
#ifdef BOARD_TC_1
#define IS_BOARD_FOR_TC_ENGINE_7 true
#else
#define IS_BOARD_FOR_TC_ENGINE_7 false
#endif

#define CHANNEL_LC_ENGINE_0 0
#ifdef BOARD_LC_1
#define IS_BOARD_FOR_LC_ENGINE_0 true
#else
#define IS_BOARD_FOR_LC_ENGINE_0 false
#endif

#define CHANNEL_LC_ENGINE_1 2
#ifdef BOARD_LC_1
