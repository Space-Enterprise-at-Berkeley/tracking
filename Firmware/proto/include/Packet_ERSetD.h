...
public:
    ...
    static PacketERSetD fromRawPacket(Comms::Packet *packet)
    {
        float v_m_Value = Comms::packetGetFloat(packet, 0);
        return PacketERSetD(v_m_Value);
    }
