...
#define PACKET_ID_SecondPointCalibration 101
...
public:
    ...
    static PacketSecondPointCalibration fromRawPacket(Comms::Packet *packet)
    {
        uint8_t v_m_Channel = Comms::packetGetUint8(packet, 0);
        float v_m_Value = Comms::packetGetFloat(packet, 1);
        return PacketSecondPointCalibration(v_m_Channel, v_m_Value);
    }
