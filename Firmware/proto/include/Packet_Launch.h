...
public:
    ...
    static PacketLaunch fromRawPacket(Comms::Packet *packet)
    {
        ...
        return PacketLaunch(v_m_SystemMode, v_m_BurnTime, v_m_NitrousEnable, v_m_IpaEnable);
    }
