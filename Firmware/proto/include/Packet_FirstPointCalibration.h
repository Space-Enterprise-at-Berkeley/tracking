...
#define PACKET_ID_FirstPointCalibration 100
...
public:
    ...
    static PacketFirstPointCalibration fromRawPacket(Comms::Packet *packet)
    {
        uint8_t v_m_Channel = Comms::packetGetUint8(packet, 0);
        float v_m_Value = Comms::packetGetFloat(packet, 1);
        return PacketFirstPointCalibration(v_m_Channel, v_m_Value);
    }
